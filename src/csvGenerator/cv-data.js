...
export const SalesData = {
  ...
  subject: "Sales Quotation for Subscription Services",
  subscriptions: [
    {
      type: "Type 1",
      description: "Brief description of services",
      duration: "Number of months/years",
      price: "$XX per month/year",
    },
    {
      type: "Type 2",
      description: "Brief description of services",
  ...
  paymentTerms:
    "Specify your payment terms, such as payment methods accepted, due date, etc.",
  termsAndConditions:
    "Include any relevant terms and conditions, such as refund policy, cancellation policy, etc.",
  validity: "This quotation is valid until Expiration Date",
  sender: {
